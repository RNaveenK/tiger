/**
 * Valid ISO 4217 three-letter currency codes.
 * This set includes active currency codes used worldwide.
 */
...
/**
 * Check if a given string is a valid ISO 4217 currency code.
 */
